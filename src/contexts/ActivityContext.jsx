...
export function ActivityProvider({ children, stopwatchTime, broadcastTimeAddedEvent }) {
  ...
  const [activities, setActivities] = useState(() => {
    ...
    return savedActivities
      ...
      : [
        { id: 1, name: "SLEEP", color: "#ff0000" , totalTime: 9000000, yearTime: 0, monthTime: 0, weekTime: 0, dayTime: 0 },
        { id: 2, name: "HOMEWORK", color: "#3366ff", totalTime: 600000, yearTime: 0, monthTime: 0, weekTime: 0, dayTime: 0 },
